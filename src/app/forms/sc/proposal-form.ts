...
export class ProposalForm extends BaseForm {
  ...
  getForm() {
    ...
    return this.form = this.fb.group({
      task_id: [null, Validators.compose([Validators.required,])],
      current_proposal_status: [null, Validators.compose([Validators.required])],
      worker_comment: [null, Validators.compose([Validators.required])],
      proposal_time: [null, Validators.compose([Validators.required])],
